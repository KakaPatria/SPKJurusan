    ...
    <form action="{{ route('admin.alumni.update', $alumni->id) }}" method="POST" class="max-w-2xl" id="alumniForm">
            ...
            <div id="ipsScores" class="hidden">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                    ...
                    <div>
                        ...
                        <input type="number" name="sosiologi" step="0.01" min="0" max="100" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-maroon text-sm" 
                            value="{{ old('sosiologi', $alumni->sosiologi) }}" placeholder="0-100" oninput="validateScore(this)">
                    ...
                    <div>
                        ...
                        <input type="number" name="sejarah" step="0.01" min="0" max="100" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-maroon text-sm" 
                            value="{{ old('sejarah', $alumni->sejarah) }}" placeholder="0-100" oninput="validateScore(this)">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6 border-l-4 border-green-400">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Tahun Lulus SMA Bima Ambulu</label>
